...
\end{etaremune}
may be split into multiple TCP packets (with \ac{TCP} specific header information such as source and destination ports), which are encapsulated in an \ac{IP} packet ()
