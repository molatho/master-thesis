...
Building up on pre-existing network infrastructure and in order to meet requirements specific to specific fields of use and use-case scenarios, the landscape of \ac{IoT} attends with a great variety of \emph{communication protocols} (further used to refer to both transport and application protocols). This section will provide a brief overview of the working principles, use cases and history of some protocols commonly used in \ac{IoT} and \ac{IIoT} applications today.
\paragraph{HTTP/S} \emph{TBD} %TODO
\paragraph{WebSockets} \emph{TBD} %TODO
\paragraph{MQTT} \emph{TBD} %TODO
\paragraph{Modbus} \emph{TBD} %TODO
\paragraph{Profibus/Profinet} \emph{TBD} %TODO
\paragraph{OPC UA} \emph{TBD} %TODO
