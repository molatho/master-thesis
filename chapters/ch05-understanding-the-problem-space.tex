...
\begin{figure}[h]
    ...
    \captionof{figure}{The simplistic architecture of the first scenario.}
    \label{fig:arch-ics}
\end{figure}
\begin{itemize}
...
\begin{figure}[h]
    ...
    \captionof{figure}{The central \ac{MQTT} broker relays messages to subscribed clients. In this case, the \ac{A/C} unit receives messages published to a topic it subscribed to.}
...
\begin{figure}[h!]
    ...
    \captionof{figure}{\ac{MQTT} clients for each station of the water treatment plant publish messages about their tanks' levels to individual topics and subscribe to their succeeding station's tank levels in order to simulate flushing water into their input tanks.}
...
\begin{figure}[h]
    ...
    \captionof{figure}{The structure of messages in the prototype: messages hold information about their communication direction, protocol-specific meta data and type-dependent payloads.}
...
\begin{figure}[h]
    ...
    \captionof{figure}{A variation of the abstract factory design pattern was used to decouple the creation of objects from their usage.}
...
\begin{table}[h]
    ...
    \begin{tabular}{r|c|c|c|c|c|c|c}
        ...
        \midrule
        Scapy          & 2021-04-19        & Python & Various    & \cellcolor{green!25}F  & \cellcolor{green!25}F  & \cellcolor{green!25}F  & \cellcolor{green!25}Y\\ %https://github.com/byt3bl33d3r/MITMf
        \midrule
        MITMf          & 2015-08-28        & Python & Various    & \cellcolor{green!25}F  & \cellcolor{green!25}F  & \cellcolor{green!25}F  & \cellcolor{green!25}Y\\ %https://github.com/byt3bl33d3r/MITMf
        \midrule
        ...
        \midrule
        mitmproxy      & 2021-01-21        & Python & \makecell{\ac{HTTPS}, \ac{WS},\\ \ac{TLS}, \ac{TCP}} & \cellcolor{orange!25}P & \cellcolor{orange!25}P & \cellcolor{orange!25}P & \cellcolor{green!25}Y\\ %https://github.com/mitmproxy/mitmproxy
        \midrule
        mProxy         & Pre-Releases only & Go     & \makecell{\ac{MQTT}, \\\ac{MQTT}/\ac{WS}}       & \cellcolor{green!25}F                      & \cellcolor{green!25}F  & \cellcolor{green!25}F & \cellcolor{green!25}Y                     \\ %https://github.com/mainflux/mproxy
        \midrule
        IOXY           & Source only       & Go     & \makecell{\ac{MQTT},\\ \ac{MQTT}/\ac{WS},\\ \ac{MQTT}/\ac{TLS}}       & \cellcolor{green!25}F  & \cellcolor{green!25}F  & \cellcolor{green!25}F & \cellcolor{green!25}Y \\ %https://github.com/mainflux/mproxy
        \bottomrule
    \end{tabular}
